...
function usage()
{
	...
	echo "                    '1.5' would give the base-calling accuracy around 89\%, "
	echo "                    '2.0' would give the base-calling accuracy around 84\%, "
	echo "                    '2.5' would give the base-calling accuracy around 76\%. "
	echo ""
